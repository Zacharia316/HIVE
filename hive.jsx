    ...
    <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
      <div style={{ padding:"20px 20px 12px", flexShrink:0 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10, background:COLORS.card, borderRadius:12, padding:"10px 14px", boxShadow:`inset 2px 2px 6px #06060c` }}>
          <Icons.Search />
          <input value={search} onChange={e=>{ setSearch(e.target.value); searchUsers(e.target.value); if(!e.target.value.trim()) setShowSearch(false); else setShowSearch(true); }} "Find users..." : "Search chats"} style={{ background:"none", border:"none", outline:"none", color:COLORS.text, fontFamily:"inherit", fontSize:14, flex:1 }} />
        </div>
      </div>
